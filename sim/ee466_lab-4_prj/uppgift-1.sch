...
<Properties>
  ...
  <Grid=10,10,1>
  <DataSet=uppgift-1.dat>
  <DataDisplay=uppgift-1.dpl>
  <OpenDisplay=0>
  <Script=uppgift-1.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <.AC AC1 1 440 180 0 41 0 0 "log" 1 "10 Hz" 1 "10 MHz" 1 "61" 1 "no" 0>
  <.SW SW1 1 620 180 0 68 0 0 "AC1" 1 "lin" 1 "R1" 1 "10 Ohm" 1 "1 MOhm" 1 "10" 1>
</Components>
<Wires>
...
<Diagrams>
  <Rect 179 697 561 294 3 #c0c0c0 1 10 1 10 1 1e+07 1 -0.0998249 0.2 1.09998 1 -1 0.5 1 315 0 225 "" "" "">
