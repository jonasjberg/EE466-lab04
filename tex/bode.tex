...
%\begin{equation}\label{eq:amp-peak}
%  $U_{in} = 1 V_{pp}$
%\end{equation}
...
%\begin{longtable}[c]{@{}ccccc@{}}
  ...
  %\\\addlinespace
  %\midrule\endhead
   %100 & 1.004 & 0.00 & \SI{-17}{\milli}   & -3.6 \\\addlinespace 
   %200 & 0.998 & 0.00 & \SI{-68m}{\milli}  & -7.2 \\\addlinespace 
   %300 & 0.997 & 0.00 & \SI{-155m}{\milli} & -10  \\\addlinespace % 1mS
   %500 & 0.990 & 0.00 & \SI{-411m}{\milli} & -17  \\\addlinespace % 0.1mS   ???
   %700 & 0.984 & 0.00 & \SI{-770m}{\milli} & -23  \\\addlinespace % 0.15mS  ???
  %1000 & 0.958 & 0.00 & \SI{-1.46}{\milli} & -32  \\\addlinespace % 0.1mS   ???
  %1200 & 0.952 & 0.00 & \SI{-1.97}{\milli} & -37  \\\addlinespace % 60uS
  %1300 & 0.949 & 0.00 & \SI{-2.24}{\milli} & -39  \\\addlinespace % ????
  %1500 & 0.943 & 0.00 & \SI{-2.77}{\milli} & -43  \\\addlinespace % 40uS
  %1600 & 0.940 & 0.00 & \SI{-3.03}{\milli} & -45  \\\addlinespace % 35uS
  %1700 & 0.938 & 0.00 & \SI{-3.30}{\milli} & -47  \\\addlinespace % ?????
  %1800 & 0.936 & 0.00 & \SI{-3.59}{\milli} & -48  \\\addlinespace % 35uS
  %1900 & 0.934 & 0.00 & \SI{-3.86}{\milli} & -50  \\\addlinespace % 35uS
  %2000 & 0.932 & 0.00 & \SI{-4.12}{\milli} & -51  \\\addlinespace % ????
  %\bottomrule
  %\addlinespace
  %\caption[]{Mätresultat för kretsen i Figur~\ref{fig:rc-schema}.}
  %\label{8a-table}
